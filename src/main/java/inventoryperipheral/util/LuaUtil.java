...
public class LuaUtil {
	...
	public static ModContainer getModContainer() {
		return FMLCommonHandler.instance().findContainerFor(InventoryPeripheral.instance);
	}
	...
	/**
	 * Recursively copies a directory from source to destination including all the files within the folders
	 */
	...
	public static void extractZipToLocation(File zipFile, String sourceFolder, String destFolder) {
		try {
			...
			InventoryPeripheral.logger.warn("Error while extracting Lua files. Peripheral may not automount Lua files! Exception follows.");
			e.printStackTrace();
		}
	}
